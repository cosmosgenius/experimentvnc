...
our %config = (
  ...
  openssldir => "/Users/sharat/projects/github/experimentvnc/vnc/openssl-osx",
  options => "--prefix=/Users/sharat/projects/github/experimentvnc/vnc/openssl-osx --openssldir=/Users/sharat/projects/github/experimentvnc/vnc/openssl-osx no-afalgeng no-asan no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dso no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-engine no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-hw no-idea no-md2 no-msan no-rc5 no-sctp no-shared no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "darwin-thread-multi-2level",
  perl_cmd => "/usr/local/Cellar/perl/5.28.0/bin/perl",
  perl_version => "5.28.0",
  perlargv => [ "--prefix=/Users/sharat/projects/github/experimentvnc/vnc/openssl-osx", "--openssldir=/Users/sharat/projects/github/experimentvnc/vnc/openssl-osx", "no-idea", "no-shared", "no-dso", "no-hw", "no-engine", "no-ssl3", "darwin64-x86_64-cc" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  prefix => "/Users/sharat/projects/github/experimentvnc/vnc/openssl-osx",
  processor => "",
  rc4_int => "unsigned int",
  sdirs => [ "objects", "md4", "md5", "sha", "mdc2", "hmac", "ripemd", "whrlpool", "poly1305", "blake2", "siphash", "sm3", "des", "aes", "rc2", "rc4", "aria", "bf", "cast", "camellia", "seed", "sm4", "chacha", "modes", "bn", "ec", "rsa", "dsa", "dh", "sm2", "dso", "buffer", "bio", "stack", "lhash", "rand", "err", "evp", "asn1", "pem", "x509", "x509v3", "conf", "txt_db", "pkcs7", "pkcs12", "comp", "ocsp", "ui", "cms", "ts", "srp", "cmac", "ct", "async", "kdf", "store" ],
  shlib_major => "1",
  shlib_minor => "1",
